...
/**
 * Created by Imen on 09/04/2017.
 */

public class EnregistrementAdabter  extends
        RecyclerView.Adapter<EnregistrementAdabter.ViewHolder> {
    private List<Enregistrement> mSites;

    private Context mContext;

    EnregistrementAdabter(Context c, List<Enregistrement> l)
    {
        mContext=c;
        mSites=l;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Enregistrement site = mSites.get(position);
